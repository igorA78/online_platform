# Generated by Django 4.2.8 on 2023-12-28 11:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='provider_contact', to='net.contact', verbose_name='Контакты')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='net_contact', to='net.contact', verbose_name='Контакты сети')),
                ('product', models.ManyToManyField(related_name='product', to='net.product', verbose_name='Продукты')),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='provider', to='net.provider', verbose_name='Поставшик')),
            ],
            options={
                'verbose_name': 'Сеть',
